...
function Section({
  ...
  return (
    <section className="mb-3">
      <h2
        className="pb-1 text-[9.5px] font-bold uppercase tracking-[0.1em]"
...
export function MinimalHtmlResume({ document, brandColor, onChange }: MinimalHtmlResumeProps) {
  return (
    <div className="px-12 py-9 text-[10px] leading-[1.4] text-neutral-900">
      <header
