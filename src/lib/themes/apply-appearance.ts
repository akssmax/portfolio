...
export function applyAppearanceToDocument(
  ...
  // Preserve the Vercel monochrome palette for current users who still have the legacy default saved.
  const themeId = state.palette === "default" ? "vercel" : state.palette
