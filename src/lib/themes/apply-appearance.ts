...
export function applyAppearanceToDocument(
  ...
  // Default palette: Vercel in light mode, brand accents in dark mode.
  const themeId =
    state.palette === "default" && mode === "light"
      ? DEFAULT_LIGHT_THEME_ID
      : state.palette
