...
export function FeatureCard({
  ...
  return (
    <HoverCard openDelay={0} closeDelay={0} onOpenChange={setPreviewOpen}>
      ...
      {previewSrc ? (
        <HoverCardContent side="bottom" align="end" sideOffset={12} collisionPadding={16} avoidCollisions style={{ animation: "none" }} className="hidden w-[min(440px,calc(100vw-2rem))] overflow-hidden rounded-xl border border-border bg-popover p-1.5 shadow-xl sm:block">
