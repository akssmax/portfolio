// React Bits ShapeWaves: https://reactbits.dev/backgrounds/shape-waves
...
export default function ShapeWaves({
    ...
    void (async () => {
      try {
        ...
        const render = now => {
          frameId = 0;
          if (disposed || failed) return;
          if (lastRenderTime && now - lastRenderTime < MIN_FRAME_INTERVAL) {
  ...
  return (
    <div
      ...
      data-ready={ready}
      style={{ backgroundColor: ready ? backgroundColor : 'transparent' }}
      aria-hidden="true"
    >
