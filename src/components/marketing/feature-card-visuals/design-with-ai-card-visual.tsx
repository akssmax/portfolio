...
export function DesignWithAiCardVisual({
  ...
  return (
    <div className={cn("relative h-full w-full overflow-hidden", className)}>
      ...
      <div
        className={cn(
          "absolute bottom-0 right-0 z-0 transition-transform duration-500 ease-out",
          fullMotion && "group-hover/visual:translate-y-[-1px]",
          size === "wide"
      ...
      <div
        className={cn(
          "absolute z-10 transition-transform duration-500 ease-out",
          fullMotion && "group-hover/visual:translate-y-[-3px]",
          size === "wide"
